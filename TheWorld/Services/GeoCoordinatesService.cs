namespace TheWorld.Services
{
    ...
    public class GeoCoordinatesService
    {
        ...
        public GeoCoordinatesService(ILogger<TripsController> logger, IConfigurationRoot config)
        {
            this.logger = logger;
            this.config = config;
        }
        ...
        {
            var result = new GeoCoordinatesResult() { Success = false, Message = "Failed to get coordinates" };
